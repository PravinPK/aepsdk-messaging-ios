...
@available(iOS 15.0, *)
public class ContentCardContainerUI: Identifiable {
    ...
    let settings: ContentCardContainerSetting
    ...
    init(_ contentCards: [ContentCardUI], settings: ContentCardContainerSetting = ContentCardContainerSetting()) {
