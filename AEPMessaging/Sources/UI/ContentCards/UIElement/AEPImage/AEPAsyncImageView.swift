...
struct AEPAsyncImageView<Content>: View where Content: View {
    ...
    /// Determines if the app is currently in the foreground (active state).
    /// - Returns: A boolean value indicating whether the app is in the foreground.
    private func isAppForeground() -> Bool {
