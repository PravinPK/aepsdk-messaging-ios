...
> **Note** - When using `InboxUI.view`, state transitions are handled automatically. Use `InboxState` directly only when you need to build fully custom rendering outside of the provided view.
